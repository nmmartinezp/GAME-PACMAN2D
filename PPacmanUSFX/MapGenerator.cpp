...
bool MapGenerator::load(string path)
{
	...
	while (getline(file, line)) {
		...
		for (unsigned int x = 0; x < chars.size(); x++) {
			...
			case 'p':
				newObject = new Pacman(pacmanTexture, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla - 20, 5);
				newObject->setParametrosAnimacion(6);
				break;
			case 'b':
				newObject = new Fantasma(fantasma1Texture, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			case 'c':
				newObject = new Fantasma(fantasma2Texture, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			case 'd':
				newObject = new Fantasma(fantasma3Texture, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			case 'e':
				newObject = new Fantasma(fantasma4Texture, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla, 3);
				newObject->setParametrosAnimacion(4);
				break;
			case 'f':
				newObject = new Fruta(frutasTextures, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(4);
				break;
			case 'q':
				newObject = new Wall(wallTexture, x * 40, y * 30, 40, 25, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(0);
				break;
			case 'x':
				newObject = new Wall(wallTexture, x * 40, y * 30, 30, 30, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(0);
				break;
			case 'y':
				newObject = new Wall(wallTexture, x * 40, y * 30, 40, 25, anchoPantalla, altoPantalla);
			...
			case 'w':
				...
				break;
			case 'z':
				newObject = new Wall(wallTexture, x * 40, y * 30, 30, 25, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(0);
				break;
			case 'v':
				newObject = new Wall(wallTexture, x * 40, y * 30, 30, 30, anchoPantalla, altoPantalla);
				...
				break;
			case '.':
				newObject = new Coin(coinTexture, x * 40, y * 30, 25, 25, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(10);
				break;
			case 'k':
				newObject = new Wall(barraTexture, x * 40, y * 30, 500, 40, anchoPantalla, altoPantalla);
				newObject->setParametrosAnimacion(0);
				break;
			}
